...
def main():
    ...
    parser.add_argument('-s', '--search', default='Grilled_Wagyu', type=str, help='search term')
    parser.add_argument('-n', '--num_images', default=100, type=int, help='num images to save')
    parser.add_argument('-d', '--directory', default='/Users/jaybergonia/Desktop/PythonProg/', type=str, help='save directory')
